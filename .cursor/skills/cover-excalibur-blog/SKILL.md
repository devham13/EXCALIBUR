...
**Lock (reference i2i):** голубые глаза, короткие тёмно-русые волосы, без бороды и очков — то же лицо.  
**Ретушь:** чистый ровный тон кожи, мягкий свет, без шума и пятен.  
**Мимика:** дружелюбная улыбка (не нейтральная серьёзность с reference).  
**Поза:** реагирует на тему — указывает на график, таблицу, воронку, дашборд или ключевую цифру на коллаже, если это усиливает крючок.  
**Free (агент):** одежда, реквизит, мем-костюм — по `cover_hook` и `scene_hint`.  
