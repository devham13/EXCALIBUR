...
| Human voice | 15 | 15 | 0 AI-slop hits, Flesch RU 81.7 |
| Fact safety | 15 | 13 | fact-check PASS; 2 числа не в fact-bank (ориентиры объёма — допустимо) |
| Contract HTML | 10 | 7 | linter PASS, объём ~8600 ✓, CTA ≤3 ✓; −3 нет `<img>` с alt (рекомендация контракта) |
...
| O04 | ✓ | ol (8 шагов), ul (чек-лист 18), table |
| R01 | ✓ | ≥3 standalone блоков 40–60 слов |
| R02 | ✓ | Wordstat, Webmaster, Princeton GEO-bench — с внешними ссылками |
...
| Ept02 | ✓ | kv-ai.ru, mayai.ru internal links — HTTP 200 |
...
- total: 6, failed: 0
- OK: wordstat.yandex.ru, webmaster.yandex.ru, /geo-optimizaciya-sajta-2026/, /, kv-ai.ru/obuchenie-po-make, kv-ai.ru/artur-horosheff
...
- Flesch RU: 81.7 (Very Easy)
- see `slop-detector-report.json`

## Fact-check

- verdict: pass (4 extracted, 2 verified in fact-bank, 2 unverified — ориентиры объёма 8500–9500, не blocker)
...
- cycle 1: H2 «Настройте мета, FAQ и schema» → «Настройте мета, разметку и schema» (duplicate FAQ linter)
