...
Indexer 2026-06-19: 0 interlink opportunities (5 статей в `memory/blog/articles`, keyword-match не сработал). Перезапустить `excalibur_blog_interlinker.py --apply` при появлении релевантных пар.
