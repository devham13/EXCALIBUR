...
Indexer 2026-06-19: 0 auto-interlinks applied (5 статей в corpus). B01 уже содержит ссылку на B04 (`geo-optimizaciya-sajta-2026` в href); keyword-match в других статьях → B01 не сработал. После publish — вручную добавить 1–2 `/blog/` ссылки hub↔spoke; перезапустить `excalibur_blog_interlinker.py --apply --blog-dir memory/blog/articles --site-base https://mayai.ru`.
