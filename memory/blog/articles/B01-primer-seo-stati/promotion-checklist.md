...
Live URL: /2026/06/19/primer-seo-stati/ (prepend PUBLIC_SITE_URL)
...
Indexer (2026-08-10): добавлено 2 internal link → B04 (`geo оптимизация`, `geo оптимизация сайта`). llms.txt обновлён (5 статей в индексе).
