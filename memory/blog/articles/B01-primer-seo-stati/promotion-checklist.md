...
Indexer (2026-09-07): 0 interlink opportunities (5 статей в `memory/blog/articles`, keyword overlap не найден). После публикации и накопления контента — перезапустить `excalibur_blog_interlinker.py --apply --blog-dir memory/blog/articles`.
