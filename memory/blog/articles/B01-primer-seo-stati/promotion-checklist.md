...
Indexer (2026-09-09): 5 статей в `memory/blog/articles`, 0 interlink opportunities — ключевые фразы не совпали в текстах других статей. `interlink-suggestions.json` сохранён. После расширения семантики — перезапустить `excalibur_blog_interlinker.py --apply`.
