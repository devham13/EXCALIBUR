...
Indexer (2026-08-08): 0 auto-inject opportunities при 5 статьях в corpus — ключевые фразы не совпали в чужих HTML без существующих `/blog/{slug}/`. Ручные ссылки в B01: `/geo-optimizaciya-sajta-2026/`, `/`. llms.txt + llms-full.txt обновлены. После publish — перезапустить interlinker при новых статьях.
