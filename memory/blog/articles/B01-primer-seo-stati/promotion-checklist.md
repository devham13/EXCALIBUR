...
Indexer (2026-09-10): 5 статей в `memory/blog/articles`, 0 auto-injected links (ключи не совпали с текстом без морфологии / уже внутри тегов). Отчёт: `interlink-report.json`. После publish — перезапустить `excalibur_blog_interlinker.py --apply --blog-dir memory/blog/articles`.
