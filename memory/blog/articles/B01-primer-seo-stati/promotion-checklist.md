...
Indexer (2026-07-09): 1 interlink applied — B01 → B04 (`geo оптимизация` → `/blog/geo-optimizaciya-sajta-2026/`). llms.txt обновлён: 5 статей в `memory/blog/llms.txt` + `memory/blog/llms-full.txt`.
