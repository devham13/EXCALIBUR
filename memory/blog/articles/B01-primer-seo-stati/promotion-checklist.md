...
Indexer 2026-06-18: interlinker `--apply` — **0** автовставок (5 статей в индексе; «geo оптимизация» в B01 уже внутри `<a href="/">`, interlinker пропускает). llms.txt / llms-full.txt обновлены (5 статей). После publish — исправить href B01→B04 вручную или перезапустить interlinker после снятия старой ссылки.
