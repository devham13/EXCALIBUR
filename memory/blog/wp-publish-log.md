...
| verdict | **PASS** |
| post_id | 238 |
| featured_image_id | 702 |
| inline_images | 703, 704, 705 |
| permalink | https://mayai.ru/2026/06/19/primer-seo-stati/ |
| transport | SFTP+HTTP (FTP blocked: 425 Bad IP) |
| trigger | excalibur-blog-publish Cloud Agent |
...
# FTP failed 425 Security: Bad IP — publish via SFTP upload + HTTP trigger (paramiko)
python3 scripts/excalibur_blog_interlinker.py --apply --blog-dir memory/blog/articles --site-base $PUBLIC_SITE_URL  # 0 opportunities
```
...
OK featured_image=702
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=703 src=cover/inline-01.png url=https://mayai.ru/wp-content/uploads/2026/06/primer-seo-stati-inline-01-36.png
OK inline_image_upload=704 src=cover/inline-02.png url=https://mayai.ru/wp-content/uploads/2026/06/primer-seo-stati-inline-02-36.png
OK inline_image_upload=705 src=cover/inline-03.png url=https://mayai.ru/wp-content/uploads/2026/06/primer-seo-stati-inline-03-36.png
permalink=https://mayai.ru/2026/06/19/primer-seo-stati/
```
