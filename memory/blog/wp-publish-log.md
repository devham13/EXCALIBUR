...
| verdict | **PASS** |
| post_id | 238 |
| featured_image_id | 531 |
| inline_images | 532, 533, 534 |
| permalink | https://mayai.ru/2026/06/19/primer-seo-stati/ |
| trigger | `excalibur-blog-publish` (Cloud Automation 2026-07-10) |
...
- cover/cover.png + alt: present
- EXCALIBUR_BLOG_ALLOW_PUBLISH: yes
- PUBLIC_SITE_URL: EXCALIBUR_PUBLIC_SITE_URL (production)
...
OK featured_image=531
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=532 src=cover/inline-01.png
OK inline_image_upload=533 src=cover/inline-02.png
OK inline_image_upload=534 src=cover/inline-03.png
permalink=https://mayai.ru/2026/06/19/primer-seo-stati/
```
...
- promotion-checklist.md: Live URL updated
- shared/published-articles.md: status published
