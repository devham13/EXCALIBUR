...
| verdict | **PASS** |
| post_id | 238 |
| featured_image_id | 686 |
| inline_images | 687, 688, 689 |
| permalink | https://mayai.ru/2026/06/19/primer-seo-stati/ |
| transport | SFTP fallback (FTP passive STOR 425 Bad IP на payload ~8.4 MB) |

### Preconditions

- article-qa.md: PASS (94/100)
- link-verify.json: pass (5/5, preflight 2026-08-07)
- schema.jsonld: present
- cover/cover.png + alt: present
- EXCALIBUR_BLOG_ALLOW_PUBLISH: yes
- site.env.local: создан из Cloud Secrets (не в git)

### Attempt

```bash
python3 scripts/excalibur_blog_link_verify.py ... --site-base $EXCALIBUR_PUBLIC_SITE_URL  # pass
python3 scripts/excalibur_blog_wp_publish.py --article-dir ... --dry-run  # OK, PHP 8420198 bytes
python3 scripts/excalibur_blog_wp_publish.py --article-dir ...  # FAIL ftplib 425 Bad IP (large STOR)
# SFTP fallback (paramiko): upload + HTTP trigger — PASS
...
OK featured_image=686
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=687 src=cover/inline-01.png
OK inline_image_upload=688 src=cover/inline-02.png
OK inline_image_upload=689 src=cover/inline-03.png
permalink=https://mayai.ru/2026/06/19/primer-seo-stati/
```
