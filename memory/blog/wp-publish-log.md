...
| verdict | **PASS** |
| post_id | 238 |
| featured_image_id | 788 |
| inline_images | 789, 790, 791 |
| permalink | https://mayai.ru/2026/06/19/primer-seo-stati/ |
| publish_method | SSH SCP + PHP CLI (FTP 425 Bad IP) |
...
- schema.jsonld: present
- cover/cover.png + alt: present (PARTIAL cover from prior run)
- EXCALIBUR_BLOG_ALLOW_PUBLISH: yes
...
# Fallback: SCP bootstrap + SSH php excalibur-blog-publish-once.php                     # PASS
...
OK featured_image=788
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=789 src=cover/inline-01.png
OK inline_image_upload=790 src=cover/inline-02.png
OK inline_image_upload=791 src=cover/inline-03.png
permalink=https://mayai.ru/2026/06/19/primer-seo-stati/
```

Live HTTP 200 verified via curl.
