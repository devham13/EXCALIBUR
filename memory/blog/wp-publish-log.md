...
## 2026-07-13 — B01 primer-seo-stati — **PASS**
...
| verdict | **PASS** |
| post_id | 238 |
| featured_image_id | 648 |
| inline_images | 649, 650, 651 |
| permalink | ${EXCALIBUR_PUBLIC_SITE_URL}/2026/06/19/primer-seo-stati/ |
| transport | SFTP (FTP 425 Bad IP in Cloud; `EXCALIBUR_PUBLISH_TRANSPORT=sftp`) |

### Preconditions

- article-qa.md: PASS (96/100)
- link-verify.json: pass (4/4, preflight 2026-07-13)
- schema.jsonld: present
- cover/cover.png + alt: present
- EXCALIBUR_BLOG_ALLOW_PUBLISH: yes
...
EXCALIBUR_PUBLISH_TRANSPORT=sftp python3 scripts/excalibur_blog_wp_publish.py --article-dir memory/blog/articles/B01-primer-seo-stati
...
OK featured_image=648
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=649 src=cover/inline-01.png
OK inline_image_upload=650 src=cover/inline-02.png
OK inline_image_upload=651 src=cover/inline-03.png
permalink=${EXCALIBUR_PUBLIC_SITE_URL}/2026/06/19/primer-seo-stati/
```
