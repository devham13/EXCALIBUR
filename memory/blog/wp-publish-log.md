...
| verdict | **PASS** |
| post_id | 238 |
| featured_image_id | 640 |
| inline_images | 641, 642, 643 |
| schema_meta | ok |
...
- article-qa.md: PASS (94/100)
- link-verify.json: pass (7/7, retry after transient kv-ai.ru reset)
- schema.jsonld: present
- cover/cover.png + alt: present
- EXCALIBUR_BLOG_ALLOW_PUBLISH: yes
...
# publish: SFTP bootstrap (FTP 425 Security: Bad IP from Cloud egress)
```
...
OK featured_image=640
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=641 src=cover/inline-01.png url=https://mayai.ru/wp-content/uploads/2026/06/primer-seo-stati-inline-01-27.png
OK inline_image_upload=642 src=cover/inline-02.png url=https://mayai.ru/wp-content/uploads/2026/06/primer-seo-stati-inline-02-27.png
OK inline_image_upload=643 src=cover/inline-03.png url=https://mayai.ru/wp-content/uploads/2026/06/primer-seo-stati-inline-03-27.png
permalink=https://mayai.ru/2026/06/19/primer-seo-stati/
```
