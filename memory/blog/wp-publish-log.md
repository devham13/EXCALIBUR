...
| verdict | **FAIL** |
| post_id | — |
| permalink | /2026/09/11/nastroyka-cursor-automations/ (live on EXCALIBUR_PUBLIC_SITE_URL) |
...
OK schema_meta=1
permalink=/2026/09/11/nastroyka-cursor-automations/
```
...
## 2026-09-11 — B06 nastroyka-cursor-automations — **PASS**
...
| verdict | **PASS** |
| post_id | 1050 |
| featured_image_id | 1051 |
| inline_images | 1052, 1053, 1054 |
| permalink | /2026/09/11/nastroyka-cursor-automations/ (live on EXCALIBUR_PUBLIC_SITE_URL) |
| publish_method | SFTP+HTTP fallback (FTP 425 Bad IP from Cloud) |
...
python3 scripts/excalibur_blog_wp_publish.py ... --dry-run  # OK, PHP 5900338 bytes
# FTP failed: 425 Security Bad IP
# SFTP upload + HTTP trigger: PASS
```

### Result

```
OK post=1050 slug=nastroyka-cursor-automations
OK featured_image=1051
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=1052 src=cover/inline-01.png
OK inline_image_upload=1053 src=cover/inline-02.png
OK inline_image_upload=1054 src=cover/inline-03.png
permalink=/2026/09/11/nastroyka-cursor-automations/
```
