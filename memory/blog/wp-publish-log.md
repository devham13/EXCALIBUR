...
| verdict | **PASS** |
| post_id | 238 |
| featured_image_id | 773 |
| inline_images | 774, 775, 776 |
...
- article-qa.md: PASS (95/100)
- link-verify.json: pass (5/5, preflight publish)
- schema.jsonld: present
- cover/cover.png + alt: present
- EXCALIBUR_BLOG_ALLOW_PUBLISH: yes
...
OK featured_image=773
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=774 src=cover/inline-01.png
OK inline_image_upload=775 src=cover/inline-02.png
OK inline_image_upload=776 src=cover/inline-03.png
permalink=/2026/06/19/primer-seo-stati/
```
