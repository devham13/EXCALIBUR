...
| verdict | **PASS** |
| post_id | 238 |
| featured_image_id | 949 |
| inline_images | 950, 951, 952 |
| permalink | https://mayai.ru/2026/06/19/primer-seo-stati/ |
| transport | ssh_sftp_bootstrap (FTP data channel 425 Bad IP from Cloud; SFTP + HTTP trigger OK) |

### Preconditions

- article-qa.md: PASS (94/100)
- link-verify.json: pass (8/8, preflight 2026-08-27)
- schema.jsonld: present
- cover/cover.png + alt: present
- EXCALIBUR_BLOG_ALLOW_PUBLISH: yes
...
# publish: SSH SFTP bootstrap (FTP STOR blocked 425 Bad IP)
```
...
OK featured_image=949
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=950 src=cover/inline-01.png url=https://mayai.ru/wp-content/uploads/2026/06/primer-seo-stati-inline-01-63.png
OK inline_image_upload=951 src=cover/inline-02.png url=https://mayai.ru/wp-content/uploads/2026/06/primer-seo-stati-inline-02-63.png
OK inline_image_upload=952 src=cover/inline-03.png url=https://mayai.ru/wp-content/uploads/2026/06/primer-seo-stati-inline-03-63.png
permalink=https://mayai.ru/2026/06/19/primer-seo-stati/
```
