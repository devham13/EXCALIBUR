...
| verdict | **PASS** |
| post_id | 238 |
| featured_image_id | 661 |
| inline_images | 662, 663, 664 |
| permalink | https://mayai.ru/2026/06/19/primer-seo-stati/ |
| transport | SFTP fallback (FTP 425 Bad IP); HTTP trigger via curl/WebFetch (~20s) |
...
python3 scripts/excalibur_blog_wp_publish.py --article-dir memory/blog/articles/B01-primer-seo-stati  # SFTP + WebFetch
```
...
OK featured_image=661
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=662 src=cover/inline-01.png
OK inline_image_upload=663 src=cover/inline-02.png
OK inline_image_upload=664 src=cover/inline-03.png
permalink=https://mayai.ru/2026/06/19/primer-seo-stati/
```
