...
## 2026-09-10 — B01 primer-seo-stati — **PASS**
...
| verdict | **PASS** |
| post_id | 238 |
| featured_image_id | 1036 |
| inline_images | 1037, 1038, 1039 |
| permalink | /2026/06/19/primer-seo-stati/ |
| transport | SFTP upload + HTTP trigger (FTP blocked: 425 Bad IP from Cloud egress) |
| trigger | excalibur-blog-publish automation |
...
- cover/cover.png + alt: present
- EXCALIBUR_BLOG_ALLOW_PUBLISH: yes
- site.env.local synced: FTP_PASS←FTP_PASSWORD, FTP_ROOT←REMOTE_SITE_ROOT, PUBLIC_SITE_URL←EXCALIBUR_PUBLIC_SITE_URL

### Result

```
OK post=238 slug=primer-seo-stati
OK featured_image=1036
OK schema_meta=1
OK skip_theme_faq_meta=1
OK inline_image_upload=1037 src=cover/inline-01.png
OK inline_image_upload=1038 src=cover/inline-02.png
OK inline_image_upload=1039 src=cover/inline-03.png
permalink=/2026/06/19/primer-seo-stati/
```

### Notes

- Standard `excalibur_blog_wp_publish.py` FTP STOR failed with `425 Security: Bad IP connecting` from Cloud Agent egress.
- Publish completed via SFTP (port 22) + HTTPS bootstrap trigger; bootstrap file removed after run.
